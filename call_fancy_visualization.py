...
if __name__=="__main__":
    ...
    yaw = prob['yaw%s'%(np.argmax(prob['windFrequencies']))]-wind_direction
    boundary_x,boundary_y,boundary_z = boundary_points_function(25,boundary_radius=farm_radius)
    # wake_function
    ...
    print 'wind_direction = np.', repr(wind_direction)
